...
public class gameBoard {
	...
	public static void main(String[] args) {
		...
		gameBoard[0][0] = new TwoDirectionTile(1, 2);
		gameBoard[0][6] = new TwoDirectionTile(3, 2);
		gameBoard[6][0] = new TwoDirectionTile(0, 1);
		gameBoard[6][6] = new TwoDirectionTile(1, 3);

		// This creates the 2 top row fixed pieces
		gameBoard[0][2] = new ThreeDirectionTile(1, 2, 3);
		gameBoard[0][4] = new ThreeDirectionTile(1, 2, 3);

		// This creates the 2nd row fixed pieces
		gameBoard[2][0] = new ThreeDirectionTile(0, 1, 2);
		gameBoard[2][2] = new ThreeDirectionTile(0, 1, 2);
		gameBoard[2][4] = new ThreeDirectionTile(1, 2, 3);
		gameBoard[2][6] = new ThreeDirectionTile(0, 2, 3);

		// This creates the 4th row fixed pieces
		gameBoard[4][0] = new ThreeDirectionTile(0, 1, 2);
		gameBoard[4][2] = new ThreeDirectionTile(0, 1, 3);
		gameBoard[4][4] = new ThreeDirectionTile(0, 2, 3);
		gameBoard[4][6] = new ThreeDirectionTile(0, 2, 3);

		// This creates the 6th row fixed pieces
		gameBoard[6][2] = new ThreeDirectionTile(0, 1, 3);
		gameBoard[6][4] = new ThreeDirectionTile(0, 1, 3);
					...
					while (gameBoard[i][j] == null) {
						...
						if (randomTile == _twoDir) {
							if (_twoDirectionLeft > 0) {
								gameBoard[i][j] = new TwoDirectionTile(x, y);
							...
							if (_oppositeDirectionLeft > 0) {
								...
								gameBoard[i][j] = new OppositeDirectionTile(x, y);
							...
							if (_threeDirectionLeft > 0) {
								gameBoard[i][j] = new ThreeDirectionTile(x, y, z);
								_threeDirectionLeft--;
							} else {
								randomTile = randomTile();
							}
